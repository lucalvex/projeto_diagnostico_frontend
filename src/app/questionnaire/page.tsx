...
export default function QuestionnairePage() {
    ...
    return (
        <div className='w-screen min-h-screen flex flex-col items-center p-12 space-y-8'>
            <div className='max-w-4xl mx-auto flex flex-col text-center'>
                <h1 className='text-2xl md:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-darknut via-purple-500 to-pink-500'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 w-full max-w-5xl'>
                {modules.map((module) => (
                    ...
                    >
                        ...
                        <p className="mb-4 flex-grow text-gray-600">{module.description}</p>
